...
<body class="main">
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="${pageContext.request.contextPath }/client/ad/ad1.png" width="700" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/ad01.png" width="700" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/ad3.jpg" width="700" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/ad4.jpg" width="700" height="335" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 图书商场首页轮播图  end -->	
	<div id="divcontent">
		<table width="900px" height="150px" border="0" cellspacing="0" style="overflow:auto;background-color:#CCC;margin-bottom:5px">
			<tr>
				<td width="497" style="border-right:solid 2px #000">
					<h2>公告</h2>
