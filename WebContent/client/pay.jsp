...
<br /><br />
	...
	<div style="width:800px;margin:0 auto;border:solid 2px #CCC;background-color:#CCC">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${param.id}">&nbsp;&nbsp;&nbsp;
		支付金额：<INPUT TYPE="text" NAME="money" value="${param.money}">元
		</div>
		<div class="divBank" style="margin:0 auto">
			<div style="width:800px;margin:0 auto;border:solid 2px #CCC;background-color:white">
			<div class="divText" style="text-align:left"><h2 style="margin-left:45px">选择网上银行:</h2></div>
